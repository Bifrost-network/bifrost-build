...
pkg_install musl-iptables-lib-1.6.1-1 || exit 2
...
patch -p0 < $PKGDIR/musl2.pat || exit 1
sed -i 's,LIBDIR=$(PREFIX)/lib,LIBDIR=/lib,' Makefile
sed -i 's/SHARED_LIBS = y/SHARED_LIBS = n/' Makefile
...
#########
# Compile
LDFLAGS="-static" SHARED_LIBS=n make V=1 || exit 1
