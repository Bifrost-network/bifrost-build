...
IFCONFIG="/sbin/ifconfig" IPROUTE="/sbin/ip" B-configure-1 --prefix=/$OPTPREFIX --localstatedir=/var --enable-iproute2 --disable-plugins \
...
cp $PKGDIR/server-selected-nets.conf $OPTDIR/etc
mkdir -p $OPTDIR/rc.d
