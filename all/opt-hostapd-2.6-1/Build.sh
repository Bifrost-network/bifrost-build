...
pkg_install musl-openssl-1.1.0i-1 || exit 2
...
cd $BUILDDIR || exit 1
libtool_fix-1
sed -i "s,/usr/local/,/opt/hostapd/," hostapd/Makefile

#########
# Configure
OPTPREFIX=opt/hostapd
cd hostapd || exit 1
...
#########
# Compile
CFLAGS="-Wall -Os -march=i586 -I/opt/musl/include/libnl3" V=1 make || exit 1
