...
cp $PKGDIR/Setup.local Modules || exit 1

#########
# Configure
B-configure-3 --prefix=/opt/musl --disable-shared --sysconfdir=/etc || exit 1
...
#########
# Compile
make LINKFORSHARED=" " || exit 1

#########
# Install into dir under /var/tmp/install
rm -rf "$DST"
make install DESTDIR=$DST # --with-install-prefix may be an alternative
make inclinstall DESTDIR=$DST
