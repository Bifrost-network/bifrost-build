...
#########
# Configure
OPTPREFIX=opt/imagemagick
B-configure-3 --prefix=/$OPTPREFIX --localstatedir=/var --enable-zero-configuration || exit 1
...
# Clean up
cd $DST || exit 1
rm -rf $OPTPREFIX/share $OPTPREFIX/include $OPTPREFIX/lib
