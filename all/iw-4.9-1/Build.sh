...
#########
# Compile
SBINDIR="/sbin" LDFLAGS="-static -z muldefs" CFLAGS="-Os -march=i586" make V=1 || exit 1

#########
# Install into dir under /var/tmp/install
rm -rf "$DST"
SBINDIR="/sbin" make install DESTDIR=$DST # --with-install-prefix may be an alternative
