...
pkg_install musl-libgpg-error-1.27-1 || exit 2
pkg_install musl-libgcrypt-1.8.1-1 || exit 2
...
#########
# Configure
B-configure-3 --prefix=/opt/musl --disable-cxx --bindir=/usr/bin --with-included-libtasn1 --with-included-unistring \
 --without-p11-kit --disable-nls --disable-hardware-acceleration || exit 1
