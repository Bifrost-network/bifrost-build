...
#########
# Copy packages
for p in kernel-x86_64-$KVER-$BUILDVER.tar.gz kernel-x86_64-headers-$KVER-$BUILDVER.tar.gz kernel-x86_64-firmware-$KVER-$BUILDVER.tar.gz kernel-x86_64-unsup-$KVER-$BUILDVER.tar.gz kernel-x86_64-vmlinux-$KVER-$BUILDVER.tar.gz kernel-x86_64-wireless-$KVER-$BUILDVER.tar.gz; do
